        ...
        <html lang="en">
            ...
            <body>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                ...
                                <p style="color:#494846; font-family: Century Gothic, sans-serif;">L'assurance sur veille sur vous, toujours prêt de vous !!!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin:5%; text-align:center; ">
                    <h1 class="display-4" style="color:#0dd05a">Nos Services</h1>
